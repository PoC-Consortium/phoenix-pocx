                ...
                <tr (click)="toggleExpand(row.accountId)">
                  ...
                  <td>
                    @if (row.machines.length > 0) {
                      <mat-icon class="expand-icon">{{ expandedId() === row.accountId ? 'expand_less' : 'expand_more' }}</mat-icon>
                    }
                  </td>
                </tr>
              }
            ...
            <div class="expanded-detail">
              ...
              @for (machine of account.machines; track machine.machineId) {
                <div class="detail-row">
                  ...
                  <span class="status-dot" [class.active]="machine.isActive" [class.inactive]="!machine.isActive"></span>
                </div>
              }
            </div>
          }
