...
@Component({
  ...
  styles: [`
    ...
    .log-message.info { color: #666666; }
    .log-message.success { color: #4caf50; }
    .log-message.warn, .log-message.warning { color: #ff9800; }
    .log-message.error { color: #f44336; }

    :host-context(.dark-theme) {
      .section { background: #1e1e1e; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.3); }
      .log-entry { border-bottom-color: rgba(255, 255, 255, 0.05); }
      .log-time { color: #888888; }
      .log-message { color: #999999; }
      .log-message.info { color: #999999; }
    }
  `],
})
